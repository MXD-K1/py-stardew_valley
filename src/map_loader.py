...
class MapLoader:
    ...
    def load_map(self, map_path: str) -> Player:
        ...
        # Collision tiles
        for x, y, surf in map_data.get_layer_by_name(
            "Collision"
        ).tiles():  # for x, y, surf these are tiles
            Generic(
                (x * TILE_SIZE, y * TILE_SIZE),
                pygame.surface.Surface((TILE_SIZE, TILE_SIZE)),
